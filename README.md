...
* **Figures**. These are the functions that were used to generate the figures from the paper. Data for the representative traces are also included. Note these data files are about 300 MB in total. Summary data files were generates using the functions in Data Processing. See the methods section of the manuscript for more details.
